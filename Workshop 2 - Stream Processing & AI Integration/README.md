...
1. Create a Confluent Cloud Account.
    ...
    - Log into [Confluent Cloud](https://www.confluent.io/confluent-cloud/tryfree/?utm_campaign=tm.fm-apac_cd.anz-ai-game-day_id.701Uz00000ea25wIAA&utm_medium=workshop) and enter your email and password. { To avoid impacting your production Confluent Cloud account, sign up using an email alias (e.g., youremail+ai2@company.com)—this creates a separate account while still sending emails to your main inbox.}
